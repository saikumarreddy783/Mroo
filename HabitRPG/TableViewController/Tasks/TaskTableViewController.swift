...
class TaskTableViewController: BaseTableViewController, UISearchBarDelegate, UITableViewDragDelegate, UITableViewDropDelegate {
    ...
    override func viewDidLoad() {
        ...
        tableView.register(UINib(nibName: "KidScoreGuideTableViewCell", bundle: Bundle.main), forCellReuseIdentifier: "kidScoreGuideCell")
...
//                print(task.text)
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        } else if dataSource?.showingCalender == true && indexPath.item == 0 && indexPath.section == 0 {
            // ...
        } else {
            if dataSource?.isKid == false {
