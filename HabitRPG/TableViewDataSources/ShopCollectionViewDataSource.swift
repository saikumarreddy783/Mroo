...
class ShopCollectionViewDataSource: BaseReactiveCollectionViewDataSource<InAppRewardProtocol>, ShopCollectionViewDataSourceProtocol {
    ...
    @objc var selectedGearCategory: String? {
        didSet {
            fetchGear()
            if selectedGearCategory == "Builder" {
    ...
    override func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        ...
        if let headerView = view {
            if headerView.viewTop != nil {
                headerView.viewTop.constant = indexPath.section == 0 ? extraHeight : 0
            }
    ...
    private func ifWizardConvertToMage(_ category: String?) -> String? {
        return category == "wizard" ? "Builder" : category
    }
    ...
    override func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, referenceSizeForHeaderInSection section: Int) -> CGSize {
        ...
        return CGSize(width: collectionView.bounds.width, height: section == 0 ? 50 + extraHeight : 50)
    }
