...
class InAppRewardCell: UICollectionViewCell {
    ...
    func configure(reward: InAppRewardProtocol, user: UserProtocol?) {
        ...
        currencyView.textColor = UIColor.white
        ...
        containerView.backgroundColor = UIColor("#FAD4D4")
        currencyBackgroundView.backgroundColor = UIColor("#EA5455").withAlphaComponent(0.6)
