...
class AboutViewController: BaseTableViewController, MFMailComposeViewControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        headerImageView.image = UIImage(named: "simple_logo") //Asset.gryphon.image.withRenderingMode(.alwaysTemplate)
    ...
    override func populateText() {
        navigationItem.title = "Mroo"//L10n.Titles.about
    }
...
//                cell.detailTextLabel?.text = "3.97.221.109:8081"//"habitica.com"
//            } else if indexPath.item == 1 {
