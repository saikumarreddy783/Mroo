...
class LoginTableViewController: UIViewController, UITextFieldDelegate {
    ...
    func populateText() {
        ...
        usernameField.entryView.textColor = UIColor("#3C3C3C")
        emailField.entryView.textColor = UIColor("#3C3C3C")
        passwordField.entryView.textColor = UIColor("#3C3C3C")
        passwordRepeatField.entryView.textColor = UIColor("#3C3C3C")
        
        usernameField.bottomBorder.backgroundColor = UIColor("#3C3C3C")
        emailField.bottomBorder.backgroundColor = UIColor("#3C3C3C")
        passwordField.bottomBorder.backgroundColor = UIColor("#3C3C3C")
        passwordRepeatField.bottomBorder.backgroundColor = UIColor("#3C3C3C")
        
        forgotPasswordButton.setTitle(L10n.Login.forgotPassword, for: .normal)
        
        googleLoginButton.setTitleColor(UIColor("#EA5455"), for: .normal)
        facebookLoginButton.setTitleColor(UIColor("#EA5455"), for: .normal)
        appleLoginButton.setTitleColor(UIColor("#EA5455"), for: .normal)
        ...
        privacyAttributedText.addAttribute(NSAttributedString.Key.foregroundColor, value: UIColor("#222222"), range: NSRange(location: 0, length: privacyAttributedText.length))
        ...
        privacyAttributedText.addAttribute(NSAttributedString.Key.foregroundColor, value: UIColor("#EA5455"), range: termsRange)
        let privacyRange = privacyAttributedText.mutableString.range(of: "Privacy Policy")
        privacyAttributedText.addAttributes([NSAttributedString.Key.link: "https://habitica.com/static/privacy"], range: privacyRange)
        privacyAttributedText.addAttribute(NSAttributedString.Key.foregroundColor, value: UIColor("#EA5455"), range: privacyRange)
        privacyPolicyLabel.attributedText = privacyAttributedText
        privacyPolicyLabel.linkTextAttributes = [NSAttributedString.Key.foregroundColor: UIColor("#EA5455")]
    }
    ...
    private func initialUISetup() {
        ...
        loginButton.backgroundColor = UIColor("#EA5455")
    ...
    func setupDecorations() {
        ...
        self.viewModel.outputs.beginButtonsVisibility.observeValues {[weak self] (value) in
            ...
            if weakSelf.viewModel.currentAuthType == .login {
                weakSelf.googleLoginButton.setTitle("Login With Google", for: .normal)
                weakSelf.facebookLoginButton.setTitle("Login With Facebook", for: .normal)
                weakSelf.appleLoginButton.setTitle("Login With Apple", for: .normal)
                ...
                weakSelf.googleLoginButton.setTitle("Sign Up With Google", for: .normal)
                weakSelf.facebookLoginButton.setTitle("Sign Up With Facebook", for: .normal)
                weakSelf.appleLoginButton.setTitle("Sign Up With Apple", for: .normal)
