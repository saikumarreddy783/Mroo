        ...
        if kind == UICollectionView.elementKindSectionFooter {
            ...
            if let headerImage = view.viewWithTag(1) as? UIImageView {
                if ThemeService.shared.theme.isDark {
                    headerImage.image = UIImage(named: "simple_logo")//Asset.gemPurchaseHeaderDark.image
                } else {
                    headerImage.image = UIImage(named: "simple_logo")//Asset.gemPurchaseHeader.image
                }
