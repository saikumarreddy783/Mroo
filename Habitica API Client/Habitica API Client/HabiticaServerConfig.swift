...
public class HabiticaServerConfig {
    ...
    public static let production = ServerConfiguration(scheme: "http", host: Constants.defaultProdHost, apiRoute: "api/\(Constants.defaultApiVersion)")
    ...
    public static let localhost = ServerConfiguration(scheme: "http", host: "3.97.221.109:8081", apiRoute: "api/\(Constants.defaultApiVersion)")
    ...
    public static let stub = ServerConfiguration(scheme: "http", host: "3.97.221.109:8081", apiRoute: "api/\(Constants.defaultApiVersion)")
